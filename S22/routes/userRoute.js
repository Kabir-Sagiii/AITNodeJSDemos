...
route.get("/get-data-based-on-gender", verifyToken, async (req, res) => {
...
route.get("/get-users", verifyToken, (req, res) => {
  getUser(res);
});
...
route.delete("/remove-user/:id", verifyToken, (req, res) => {
...
route.put("/update-user/:id", verifyToken, async (req, res) => {
  try {
